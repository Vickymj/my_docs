...
import fastapiSidebar from './sidebars/fastapi';
import sqlSidebar from './sidebars/sql';
import dockerSidebar from './sidebars/docker';
import flaskSidebar from './sidebars/flask';
import djangoSider from './sidebars/django';
const sidebars: SidebarsConfig = {
  docs: docsSidebar,
  Python: pythonSidebar,
  FastAPI: fastapiSidebar,
  SQL: sqlSidebar,
